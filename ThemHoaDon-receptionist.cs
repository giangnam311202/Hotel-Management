...
{
    public partial class ThemHoaDon_receptionist : Form
    {
        public ThemHoaDon_receptionist()
        {
            InitializeComponent();
        ...
        public void button4_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(Database.connection))
            {
                ...
                string query = "UPDATE PHONG SET TINHTRANG = N'Có sẵn' WHERE MAPHONG = (SELECT MAPHONG FROM PHIEUTHUEPHONG WHERE MAPTP IN (";
