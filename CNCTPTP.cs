...
{
    public partial class CNCTPTP : Form
    {
        string MAPTP;
        string MAPHONG;
        DateTime dateTime;
        ...
        string CMND;
        string MALKH;
        public CNCTPTP(string maptp, string maphong, DateTime ngaylay, string khthu, string ten, string dc, string cmnd, string mALKH)
        {
            InitializeComponent();
            MAPTP = maptp;
            MAPHONG = maphong;
